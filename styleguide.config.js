...
const homePageComponents = [
  'src/lib/containers/home_page/**/[A-Z]*.tsx',
  'src/lib/containers/widgets/themes-plot/**/ThemesPlot.tsx',
  'src/lib/containers/**/UserCardListRotate.tsx',
  'src/lib/containers/**/RssFeedCards.tsx',
  'src/lib/containers/**/TableFeedCards.tsx',
  'src/lib/containers/**/UpsetPlot.tsx',
  'src/lib/containers/**/MarkdownSynapse.tsx',
]
const ignoreComponents = ['**/*.Mobile.tsx', '**/*.Desktop.tsx']

module.exports = {
  // This should normally just be the webpackConfig object created above, but react-styleguidist does not yet support CRA v5
  // Here's a workaround: https://github.com/styleguidist/react-styleguidist/issues/1910#issuecomment-1013763698
  webpackConfig: {
    ...webpackConfig,
    module: {
  ...
  styleguideComponents: {
    Wrapper: path.resolve(
      __dirname,
      'src/lib/containers/StyleGuidistComponentWrapper',
    ),
  },
  sections: [
    {
    ...
    },
    {
      ...
      components: [
        'src/lib/containers/**/Login.tsx',
        'src/lib/containers/**/Logout.tsx',
      ],
    },
    {
    ...
    },
    {
      ...
      description:
        'Demos or examples that are useful to display here that are not components.',
      components: [
        'src/demo/containers/**/[A-Z]*.tsx',
        'src/lib/utils/typography/Typography.tsx',
      ],
    },
  ],
  ...
  template: {
    favicon:
      'https://sage-bionetworks.github.io/Synapse-React-Client/favicon.png',
    head: {
      scripts: [
        {
