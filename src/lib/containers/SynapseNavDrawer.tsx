    ...
    <div className="SynapseNavDrawer">
      <Drawer variant="permanent" className={`SynapseNavDrawerMenu 'drawerClosed`} >
          ...
          <List>
            ...
            {currentUserProfile && <ListItem className='profileItem' button key='profile' data-tip="Your Account" data-for="profileLink" onClick={selectedItem == NavItem.PROFILE ? handleDrawerClose : () => {handleDrawerOpen(NavItem.PROFILE)}}>
             <ReactTooltip
                  delayShow={300}
                  place="right"
                  type="dark"
            ...
            <ListItem className='helpItem' button key='help' data-tip="Help" data-for="helpLink" onClick={selectedItem == NavItem.PROFILE ? handleDrawerClose : () => {handleDrawerOpen(NavItem.PROFILE)}}>
              <ReactTooltip
                  delayShow={300}
                  place="right"
                  type="dark"
