...
currentUserProfile ? (
  ...
  <UserCard size={AVATAR} ownerId={273950} avatarSize="SMALL" />
)
```
...
currentUserProfile ? (
  ...
  <UserCard size={AVATAR} ownerId={273950} avatarSize="LARGE" />
)
```
...
currentUserProfile ? (
  ...
  <UserCard size={SMALL_USER_CARD} ownerId={273950} />
)
```
...
currentUserProfile ? (
  ...
  <UserCard size={MEDIUM_USER_CARD} ownerId={273950} />
)
```
...
currentUserProfile ? (
  ...
  <UserCard size={LARGE_USER_CARD} ownerId={273950} />
)
```
