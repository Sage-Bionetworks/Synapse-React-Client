        ...
        return (
            <div> 
                {React.Children.map(this.props.children, child =>{
                    return React.cloneElement(child, {showBy: "Disease", isLoading: this.state.isLoading, updateQueryRequest: this.makeQueryRequest, data: this.state.data, sql: this.props.sql,
                    })
                })} 
            </div>
        )
