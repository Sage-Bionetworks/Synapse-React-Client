...
import { PRODUCTION_ENDPOINT_OBJECT } from '../utils/getEndpoints'
  ...
  public render() {
    ...
    return (
      ...
      >
        ...
        <div>
          <a
            href={`${PRODUCTION_ENDPOINT_OBJECT.PORTAL}#!PasswordReset:0`}
          ...
          <a
            href={`${PRODUCTION_ENDPOINT_OBJECT.PORTAL}#!RegisterAccount:0`}
