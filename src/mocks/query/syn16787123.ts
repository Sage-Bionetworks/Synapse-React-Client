...
const queryResultBundle: QueryResultBundle = {
  ...
  queryResult: {
    ...
    queryResults: {
      headers: [
        { columnType: 'LARGETEXT', name: 'projectName', id: '69191' },
        { columnType: 'ENTITYID', name: 'id', id: '2510' },
        {
          columnType: 'ENTITYID',
          name: 'projectFileviewId',
          id: '69192',
        },
        { columnType: 'STRING', name: 'projectStatus', id: '69730' },
        { columnType: 'STRING', name: 'dataStatus', id: '69731' },
        { columnType: 'STRING', name: 'fundingAgency', id: '67409' },
        { columnType: 'LARGETEXT', name: 'summary', id: '69194' },
        { columnType: 'LARGETEXT', name: 'summarySource', id: '69732' },
        { columnType: 'LARGETEXT', name: 'projectLeads', id: '69195' },
        { columnType: 'LARGETEXT', name: 'institutions', id: '69196' },
        { columnType: 'STRING', name: 'tumorType', id: '71360' },
        { columnType: 'STRING', name: 'diseaseFocus', id: '69734' },
        { columnType: 'STRING', name: 'featured', id: '71578' },
      ],
  ...
  columnModels: [
    { columnType: 'LARGETEXT', name: 'projectName', id: '69191' },
    { columnType: 'ENTITYID', name: 'id', id: '2510' },
    { columnType: 'ENTITYID', name: 'projectFileviewId', id: '69192' },
    {
      columnType: 'STRING',
  ...
  facets: [
    {
      facetType: 'enumeration',
      facetValues: [
        { count: 35, isSelected: false, value: 'Active' },
        { count: 24, isSelected: false, value: 'Completed' },
      ],
      concreteType:
    ...
    },
    {
      facetType: 'enumeration',
      facetValues: [
        { count: 6, isSelected: false, value: 'None' },
        { count: 3, isSelected: false, value: 'Partially Released' },
        { count: 9, isSelected: false, value: 'Published' },
        { count: 41, isSelected: false, value: 'Under Embargo' },
      ],
      concreteType:
        'org.sagebionetworks.repo.model.table.FacetColumnResultValues',
    ...
    },
    {
      facetType: 'enumeration',
      facetValues: [
        { count: 10, isSelected: false, value: 'CTF' },
        { count: 4, isSelected: false, value: 'NIH-NCI' },
        { count: 45, isSelected: false, value: 'NTAP' },
      ],
      concreteType:
        'org.sagebionetworks.repo.model.table.FacetColumnResultValues',
    ...
    },
    {
      ...
      facetValues: [
        ...
        { count: 12, isSelected: false, value: 'Cutaneous Neurofibroma' },
        { count: 1, isSelected: false, value: 'JMML' },
        { count: 4, isSelected: false, value: 'Low Grade Glioma' },
        { count: 6, isSelected: false, value: 'MPNST' },
        { count: 28, isSelected: false, value: 'Plexiform Neurofibroma' },
        {
          count: 1,
          isSelected: false,
        ...
        { count: 1, isSelected: false, value: 'Schwannoma' },
        { count: 1, isSelected: false, value: 'Schwannoma | Meningioma' },
        { count: 1, isSelected: false, value: 'SMN' },
      ],
      concreteType:
        'org.sagebionetworks.repo.model.table.FacetColumnResultValues',
    ...
    },
    {
      facetType: 'enumeration',
      facetValues: [
        { count: 3, isSelected: false, value: 'Multiple' },
        { count: 54, isSelected: false, value: 'Neurofibromatosis 1' },
        { count: 1, isSelected: false, value: 'Neurofibromatosis 2' },
        { count: 1, isSelected: false, value: 'Schwannomatosis' },
      ],
      concreteType:
        'org.sagebionetworks.repo.model.table.FacetColumnResultValues',
