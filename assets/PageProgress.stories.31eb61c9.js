...
`,locationsMap:{demo:{startLoc:{col:54,line:15},endLoc:{col:1,line:30},startBody:{col:54,line:15},endBody:{col:1,line:30}}}}},title:"UI/PageProgress",component:p,argTypes:{}},w=t=>{const[e,r]=C.useState(0);return n(p,{barPercent:e,backBtnCallback:()=>{r(e-25)},forwardBtnCallback:()=>{r(e+25)},forwardBtnActive:e<100,...t})},_=w.bind({});_.args={barColor:"green",backBtnLabel:"Back",forwardBtnLabel:"Next"};const R=["Demo"];export{_ as Demo,R as __namedExportsOrder,N as default};
