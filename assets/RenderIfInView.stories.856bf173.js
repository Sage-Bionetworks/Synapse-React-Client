...
`,locationsMap:{demo:{startLoc:{col:56,line:10},endLoc:{col:1,line:20},startBody:{col:56,line:10},endBody:{col:1,line:20}}}}},title:"Components/RenderIfInView",component:n},w=t=>i(n,{children:i("div",{style:{backgroundColor:"#adedba",transition:"background-color 1s"},children:"RenderIfInView uses the IntersectionObserver API to allow conditional child rendering and callbacks based on viewport visibility. It will render children when it's scrolled into view."})}),I=w.bind({}),b=["Demo"];export{I as Demo,b as __namedExportsOrder,m as default};
