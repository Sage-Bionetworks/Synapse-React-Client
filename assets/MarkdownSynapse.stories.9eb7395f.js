...
Modify the markdown control to change the parameters
\${synapsetable?query=SELECT %2A FROM syn26302617&showquery=false&tableonly=false}`};const mt=["HardCodedMarkdown","WikiPage","ImageDemo","ButtonLink","ImageBySynID","Plot","SynapseTable"];export{a as ButtonLink,r as HardCodedMarkdown,m as ImageBySynID,p as ImageDemo,s as Plot,l as SynapseTable,i as WikiPage,mt as __namedExportsOrder,at as default};
