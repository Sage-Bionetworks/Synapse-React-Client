import{C as m}from"./ComplexMenu.fd7d4142.js";import{I as E}from"./IconSvg.23552105.js";import{j as u}from"./jsx-runtime.d04151d1.js";import"./DropdownMenu.a0953694.js";import"./Button.09b7bba7.js";import"./styled.1efff5b8.js";import"./ButtonBase.3d334067.js";import"./emotion-react.browser.esm.b7b35e3a.js";import"./TransitionGroupContext.1ef7d36b.js";import"./Typography.73bd7049.js";import"./Tooltip.4974d54a.js";import"./SvgIcon.d3ec47f0.js";import"./useTheme.175bd669.js";import"./index.8319c373.js";import"./iframe.d32e0f35.js";import"./Fade.f21ee508.js";import"./Paper.a663318d.js";import"./MenuList.c359cb1b.js";import"./index.f2a06ad4.js";import"./List.f7594411.js";import"./Divider.8254df1d.js";import"./Box.dfcf56d3.js";import"./IconButton.f2c2856c.js";function D(o,i){return Object.fromEntries(Object.entries(o).filter(([a,n])=>!n||!n.visible?!1:![...i.buttonActions,...i.primaryMenuActions.flat(),...i.downloadMenuActions.flat()].some(l=>l.action===a)))}function O(o,i){return o.reduce((a,n)=>{var l;const t=i[n.action];return t&&t.visible&&a.push({text:(l=t.text)!=null?l:n.action,onClick:t.onClick,href:t.href,tooltipText:t.tooltipText,disabled:t.disabled,icon:n.icon,textSx:n.textSx,iconSx:n.iconSx}),a},[])}function A(o,i){return o.reduce((a,n)=>{const t=O(n,i);return t.length>0&&a.push(t),a},[])}function c(o){const{actionConfiguration:i,menuConfiguration:a,layout:n}=o,t=D(i,n);Object.entries(t).length>0&&(console.warn("Actions are visible but have not been configured in the layout:",Object.entries(t).map(r=>r[0])),n.primaryMenuActions.unshift(Object.entries(t).map(r=>({action:r[0]}))));const l=n.buttonActions.reduce((r,d)=>{const s=i[d.action];if(s&&s.visible){let T=s.onClick;T==null&&(console.warn(`No handler registered for ${d.action}`),T=()=>{console.warn(`No handler registered for ${d.action}`)}),r.push({icon:d.icon,onClick:T,tooltipText:s.text,disabled:s.disabled})}return r},[]),p={dropdownButtonText:"Download Options",convertSingleItemToButton:!1,renderMenuIfNoItems:!1,buttonTooltip:a.DOWNLOAD.tooltipText,buttonProps:{disabled:a.DOWNLOAD.disabled,endIcon:u(E,{icon:"download",wrap:!1})},items:A(n.downloadMenuActions,i)},I={dropdownButtonText:n.primaryMenuText,convertSingleItemToButton:!0,renderMenuIfNoItems:!1,buttonProps:{endIcon:u(E,{icon:n.primaryMenuEndIcon,wrap:!1})},items:A(n.primaryMenuActions,i)};return u(m,{iconButtons:l,dropdownMenus:[p,I]})}try{c.displayName="EntityActionMenu",c.__docgenInfo={description:"The EntityActionMenu renders a menu that displays the actions that can be invoked on an Entity page.",displayName:"EntityActionMenu",props:{actionConfiguration:{defaultValue:null,description:"",name:"actionConfiguration",required:!0,type:{name:"ActionConfigurationMap"}},menuConfiguration:{defaultValue:null,description:"",name:"menuConfiguration",required:!0,type:{name:"MenuConfigurationMap"}},layout:{defaultValue:null,description:"",name:"layout",required:!0,type:{name:"EntityActionMenuLayout"}}}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["src/lib/containers/entity/page/action_menu/EntityActionMenu.tsx#EntityActionMenu"]={docgenInfo:c.__docgenInfo,name:"EntityActionMenu",path:"src/lib/containers/entity/page/action_menu/EntityActionMenu.tsx#EntityActionMenu"})}catch{}const q={parameters:{storySource:{source:`import React from 'react'
