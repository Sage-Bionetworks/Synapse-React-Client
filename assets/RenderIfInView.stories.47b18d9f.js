...
"200px", "200px 0 50px 0", "-50px" are all valid values.`,name:"rootMargin",required:!1,type:{name:"string"}},className:{defaultValue:null,description:'One or more class names to be added to the root element of this component, i.e.\n`"class-one class-two"`.',name:"className",required:!1,type:{name:"string"}}}},typeof STORYBOOK_REACT_CLASSES!="undefined"&&(STORYBOOK_REACT_CLASSES["src/lib/containers/VisibilityObserver.tsx#VisibilityObserver"]={docgenInfo:t.__docgenInfo,name:"VisibilityObserver",path:"src/lib/containers/VisibilityObserver.tsx#VisibilityObserver"})}catch{}const p=window.React;class n extends p.Component{constructor(){super(...arguments),this.getChildren=()=>i(d,{children:this.props.children})}render(){return i(t,{renderInView:this.getChildren})}}try{n.displayName="RenderIfInView",n.__docgenInfo={description:"",displayName:"RenderIfInView",props:{}},typeof STORYBOOK_REACT_CLASSES!="undefined"&&(STORYBOOK_REACT_CLASSES["src/lib/containers/RenderIfInView.tsx#RenderIfInView"]={docgenInfo:n.__docgenInfo,name:"RenderIfInView",path:"src/lib/containers/RenderIfInView.tsx#RenderIfInView"})}catch{}var m={parameters:{storySource:{source:`import React from 'react'
...
`,locationsMap:{demo:{startLoc:{col:56,line:10},endLoc:{col:1,line:20},startBody:{col:56,line:10},endBody:{col:1,line:20}}}}},title:"Components/RenderIfInView",component:n};const w=r=>i(n,{children:i("div",{style:{backgroundColor:"#adedba",transition:"background-color 1s"},children:"RenderIfInView uses the IntersectionObserver API to allow conditional child rendering and callbacks based on viewport visibility. It will render children when it's scrolled into view."})}),I=w.bind({}),b=["Demo"];export{I as Demo,b as __namedExportsOrder,m as default};
//# sourceMappingURL=RenderIfInView.stories.47b18d9f.js.map
