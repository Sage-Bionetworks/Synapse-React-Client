import{r as l,j as t,a as o,F as h}from"./jsx-runtime.732db4fa.js";import{a4 as y,dd as g,aA as S,de as w}from"./index.6ade810e.js";import{C,a as D}from"./CreatedOnByUserDiv.477669fb.js";import{W as _}from"./WarningModal.dce8a8d1.js";import{I as k}from"./IconSvg.f8a92c9e.js";import{R as I}from"./Row.4aecd146.js";import{C as E}from"./isArray.ab714070.js";import{B as T}from"./Button.14842d9b.js";import{D as r}from"./Dropdown.77cad14f.js";import"./iframe.309bdcd0.js";import"./index.f08547e5.js";import"./SynapseConstants.aef18750.js";import"./styled.7d1b1387.js";import"./Tooltip.b3eb933e.js";import"./SvgIcon.883206f0.js";import"./useTheme.23d779b8.js";import"./TransitionGroupContext.25f1619e.js";import"./FullWidthAlert.b4689dd3.js";import"./hook.7d829a86.js";import"./createWithBsPrefix.e55f4707.js";import"./divWithClassName.0d41da1a.js";import"./index.35ce73ec.js";import"./Typography.52fcc329.js";import"./Fade.a9768a9d.js";import"./getEndpoint.f1f195f5.js";import"./IconButton.4e309ec1.js";import"./ButtonBase.caa5bbee.js";import"./emotion-react.browser.esm.4ae44601.js";import"./Link.04b76f3f.js";import"./Button.2b5fc967.js";import"./UserCard.5dc8ad35.js";import"./IconCopy.8fbe8f6c.js";import"./SkeletonTable.cff03cd3.js";import"./times.37016f17.js";import"./toInteger.e9616708.js";import"./isSymbol.3aa759ff.js";import"./Skeleton.00a5a513.js";import"./ToastMessage.ca9da849.js";import"./removeClass.27874bcb.js";import"./hasClass.56fd144a.js";import"./uniqueId.68f55a89.js";import"./toString.083d15f6.js";import"./Overlay.c9c798f2.js";import"./contains.d723cb84.js";import"./usePopperMarginModifiers.7728e467.js";import"./useWaitForDOMRef.08d8bdbd.js";import"./Modal.4f0d6f21.js";import"./inheritsLoose.7bb86332.js";import"./usePrevious.90faff06.js";import"./isRequiredForA11y.20ed4857.js";const i=({evaluation:e,onEdit:d,onModifyAccess:c,onSubmit:m,onDeleteSuccess:u})=>{const{accessToken:n}=y(),[f,s]=l.exports.useState(),[a,v]=l.exports.useState();l.exports.useEffect(()=>{s(void 0),g(e.id,n).then(p=>{v(p)}).catch(p=>s(p))},[e,n]);const b=()=>{s(void 0),w(e.id,n).then(u).catch(s)};return t("div",{className:"bootstrap-4-backport evaluation-card",children:t(C,{children:o(C.Body,{children:[f&&t(S,{error:f}),a&&o(h,{children:[o(I,{children:[t(E,{children:t("label",{children:"EVALUATION QUEUE"})}),t(E,{children:t(x,{permissions:a,onDelete:b,onEdit:d,onModifyAccess:c})})]}),o("h4",{children:[e.name," (",e.id,")"]}),t("label",{children:"Description"}),t("p",{children:e.description}),t("label",{children:"Instructions"}),t("p",{children:e.submissionInstructionsMessage}),t(D,{userId:e.ownerId,date:new Date(e.createdOn)}),(a==null?void 0:a.canSubmit)&&t(T,{className:"submit-button",type:"primary",onClick:m,children:"Submit"})]})]})})})},x=({permissions:e,onEdit:d,onModifyAccess:c,onDelete:m})=>{const[u,n]=l.exports.useState(!1);return e.canEdit||e.canChangePermissions||e.canDelete?o(h,{children:[(e==null?void 0:e.canDelete)&&t(_,{title:"Delete Evaluation Queue",modalBody:"Are you sure you want to delete the Evaluation Queue?",show:u,confirmButtonText:"Delete",onConfirm:()=>{m(),n(!1)},onConfirmCallbackArgs:[],onCancel:()=>{n(!1)},confirmButtonVariant:"danger"}),o(r,{className:"float-right",children:[t(r.Toggle,{role:"menu","aria-label":"Options",variant:"link",className:"dropdown-no-caret",children:t(k,{icon:"verticalEllipsis"})}),o(r.Menu,{alignRight:!0,children:[e.canEdit&&t(r.Item,{role:"menuitem",onClick:d,children:"Edit"}),e.canChangePermissions&&t(r.Item,{role:"menuitem",onClick:c,children:"Modify Access"}),e.canDelete&&o(h,{children:[t(r.Divider,{}),t(r.Item,{role:"menuitem",onClick:()=>n(!0),children:"Delete"})," "]})]})]})]}):null};try{i.displayName="EvaluationCard",i.__docgenInfo={description:`This component is currently only intended to be used in Synapse.org.
